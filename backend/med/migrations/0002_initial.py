...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='ordonnance',
            field=models.ForeignKey(help_text='Ordonnance associée à cette distribution', on_delete=django.db.models.deletion.CASCADE, related_name='distributions', to='med.ordonnance'),
        ),
        migrations.AddField(
            model_name='consultation',
            name='ordonnance',
        ...
        migrations.AddField(
            model_name='distribution',
            name='traitement',
            field=models.ForeignKey(help_text='Médicament délivré', on_delete=django.db.models.deletion.CASCADE, related_name='distributions', to='med.traitement'),
        ),
    ]
